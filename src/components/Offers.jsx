...
const Offers = () => {
  return (
    <div name="destinations" className='max-w-[900px] m-auto px-4 py-12 flex flex-wrap justify-between'>
        <p className='text-lg font-bold text-gray-700'>Booking Incentives</p>
        <p className='text-lg font-bold text-gray-700'>Competitives Rates</p>
